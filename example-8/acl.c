...
fprintf(stderr, "+++%d : %d : %s : %d\n", data[0], l4->req->l, data, strlen(data));
//	if (strncmp("<policy-file-request/>\0", (const char *)data, 23) != 0)
//		goto not_policy;
...
//DVV
	{ "req_flash_policy",    acl_parse_nothing,    acl_fetch_flash_policy,   acl_match_nothing, ACL_USE_L6REQ_VOLATILE|ACL_MAY_LOOKUP },
//DVV
#if 0
